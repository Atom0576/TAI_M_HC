    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          A <strong>male AI</strong> manager is assigned to your team.
        </p>
        <p style={{ 
          fontSize: "18px", 
          fontWeight: "normal", 
        ...
        <p style={{ 
          ...
          "He demonstrates strong problem-solving abilities, confidently tackles challenges, assertively advocates for his ideas against opposition, and takes initiative without guidance."
        </p>
        <p style={{ 
          fontSize: "18px", 
          fontWeight: "normal", 
          ...
          The <strong>best player</strong> will be chosen based on the male AI manager's evaluations.
        </p>
      </div>
    </div>
  );
