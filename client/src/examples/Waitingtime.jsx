  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: "0", margin: "0" }}>
     ...
     <p style={{ fontSize: "18px", fontWeight: "normal", margin: "20px 0", textAlign: "left", maxWidth: "600px" }}>
       As a reminder of the style of your male AI manager, "He demonstrates strong problem-solving abilities, confidently tackles challenges, assertively advocates for his ideas against opposition, and takes initiative without guidance."
     </p>          
    </div>
  );
}
